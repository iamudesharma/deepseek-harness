...
SessionEvent _ev(
  ...
  Object? surfaceOp,
  List<int>? sourceSeqs,
}) => SessionEvent(type: type, seq: seq, time: seq * 1000, data: data);
...
List<HistoryEntry> _depth1() => [
  ...
  _h(
    _ev('tool/code-dispatch-start', 4, {
      'rootCallId': 'root-1',
      'parentCallId': 'root-1',
  ...
  _h(
    _ev('tool/code-dispatch-start', 6, {
      'rootCallId': 'root-1',
      'parentCallId': 'root-1',
...
List<HistoryEntry> _compaction() => [
  ...
  HistoryEntry(
    event: SessionEvent(
      ...
      seq: 5,
      time: 5000,
      data: {'compactionId': 'c-1', 'turn': null},
    ),
  ),
];
...
List<HistoryEntry> _manualCompaction() => [
  HistoryEntry(
    event: SessionEvent(
      ...
      seq: 1,
      time: 1000,
      data: {'commandId': 'cmd-1', 'name': 'compact', 'args': ''},
    ),
  ),
  HistoryEntry(
    event: SessionEvent(
...
List<HistoryEntry> _markdownCompaction() => [
  ...
  HistoryEntry(
    event: SessionEvent(
      ...
      seq: 5,
      time: 3000,
      data: {'compactionId': 'md-1', 'turn': null},
    ),
  ),
];
...
void main() {
  testWidgets('subcall depth1 light', (tester) async {
    ...
    await tester.pumpWidget(
      _app(SizedBox(width: 760, child: ChatView(sessionId: 'sub-1'))),
    );
    _containerOf(tester)
        .read(liveHistoryProvider('sub-1').notifier)
        .replaceAll(_depth1());
    await tester.pumpAndSettle();
    await expectLater(
      find.byType(ChatView),
      matchesGoldenFile('goldens/subcall_depth1_light.png'),
    );
  });
  ...
  testWidgets('subcall depth2 light', (tester) async {
    _setViewport(tester, const Size(900, 700));
    await tester.pumpWidget(
      _app(SizedBox(width: 760, child: ChatView(sessionId: 'sub-2'))),
    );
    _containerOf(tester)
        .read(liveHistoryProvider('sub-2').notifier)
        .replaceAll(_depth2());
    await tester.pumpAndSettle();
    await expectLater(
      find.byType(ChatView),
      matchesGoldenFile('goldens/subcall_depth2_light.png'),
    );
  });
  ...
  testWidgets('subcall depth3 error light', (tester) async {
    ...
    await tester.pumpWidget(
      _app(SizedBox(width: 760, child: ChatView(sessionId: 'sub-3'))),
    );
    _containerOf(tester)
        .read(liveHistoryProvider('sub-3').notifier)
        .replaceAll(_depth3());
    await tester.pumpAndSettle();
    await expectLater(
      find.byType(ChatView),
      matchesGoldenFile('goldens/subcall_depth3_light.png'),
    );
  });
  ...
  testWidgets('subcall depth2 out-of-order light', (tester) async {
    _setViewport(tester, const Size(900, 700));
    await tester.pumpWidget(
      _app(SizedBox(width: 760, child: ChatView(sessionId: 'sub-oo'))),
    );
    _containerOf(tester)
        .read(liveHistoryProvider('sub-oo').notifier)
        .replaceAll(_outOfOrderDepth2());
    await tester.pumpAndSettle();
    ...
    await expectLater(
      find.byType(ChatView),
      matchesGoldenFile('goldens/subcall_depth2_out_of_order_light.png'),
    );
  });
  ...
  testWidgets('compaction collapsed light', (tester) async {
    ...
    await tester.pumpWidget(
      _app(SizedBox(width: 760, child: ChatView(sessionId: 'cmp-1'))),
    );
    _containerOf(tester)
        .read(liveHistoryProvider('cmp-1').notifier)
        .replaceAll(_compaction());
    await tester.pumpAndSettle();
    await expectLater(
      find.byType(ChatView),
      matchesGoldenFile('goldens/compaction_light.png'),
    );
  });
  ...
  testWidgets('compaction expanded light', (tester) async {
    ...
    await tester.pumpWidget(
      _app(SizedBox(width: 760, child: ChatView(sessionId: 'cmp-2'))),
    );
    _containerOf(tester)
        .read(liveHistoryProvider('cmp-2').notifier)
        .replaceAll(_compaction());
    await tester.pumpAndSettle();
    ...
    await expectLater(
      find.byType(ChatView),
      matchesGoldenFile('goldens/compaction_expanded_light.png'),
    );
  });
  ...
  testWidgets('manual compaction collapsed light', (tester) async {
    _setViewport(tester, const Size(900, 600));
    await tester.pumpWidget(
      _app(SizedBox(width: 760, child: ChatView(sessionId: 'cmp-manual-1'))),
    );
    _containerOf(tester)
        .read(liveHistoryProvider('cmp-manual-1').notifier)
        .replaceAll(_manualCompaction());
    await tester.pumpAndSettle();
    await expectLater(
      find.byType(ChatView),
      matchesGoldenFile('goldens/manual_compaction_light.png'),
    );
  });
  ...
  testWidgets('manual compaction expanded light', (tester) async {
    _setViewport(tester, const Size(900, 700));
    await tester.pumpWidget(
      _app(SizedBox(width: 760, child: ChatView(sessionId: 'cmp-manual-2'))),
    );
    _containerOf(tester)
        .read(liveHistoryProvider('cmp-manual-2').notifier)
        .replaceAll(_manualCompaction());
    await tester.pumpAndSettle();
    final btn = find.byType(InkWell).first;
    await tester.tap(btn);
    ...
    await expectLater(
      find.byType(ChatView),
      matchesGoldenFile('goldens/manual_compaction_expanded_light.png'),
    );
  });
  ...
  testWidgets('markdown compaction expanded light', (tester) async {
    ...
    await tester.pumpWidget(
      _app(SizedBox(width: 760, child: ChatView(sessionId: 'cmp-md'))),
    );
    _containerOf(tester)
        .read(liveHistoryProvider('cmp-md').notifier)
        .replaceAll(_markdownCompaction());
    await tester.pumpAndSettle();
    final btn = find.byType(InkWell).first;
    await tester.tap(btn);
    await tester.pumpAndSettle();
    await expectLater(
      find.byType(ChatView),
      matchesGoldenFile('goldens/compaction_markdown_light.png'),
    );
  });
  ...
  testWidgets('compaction zh collapsed light', (tester) async {
    ...
    await tester.pumpWidget(
      _app(
        SizedBox(width: 760, child: ChatView(sessionId: 'cmp-zh')),
        locale: const Locale('zh'),
      ),
    );
    _containerOf(tester)
        .read(liveHistoryProvider('cmp-zh').notifier)
        .replaceAll(_compaction());
    await tester.pumpAndSettle();
    await expectLater(
      find.byType(ChatView),
      matchesGoldenFile('goldens/compaction_zh_light.png'),
    );
  });
}
