...
void main() {
  ...
  testWidgets(
      ...
      'immediately, and flips them back', (tester) async {
    // Wide desktop surface so the expanded sidebar (with its labeled
    // controls) is mounted rather than the collapsed icon rail.
