...
/// Closed error-code union: the keys of `RemoteErrorDetailsMap` in
/// `dsh-typert-protocol` plus every package's declaration merging (gateway,
/// session/workspace/settings/agent-preset/subagent/llm/directory-picker).
///
/// Upstream renamed the hyphen vocabulary to slash-namespaced codes; members
/// track the current wires. The hyphen `session-not-found` survives only on
/// the message-feedback path (`MessageFeedbackSessionNotFound`), so it keeps
/// its own member. `internal` is a local-only sentinel for transport folds
/// (the host validates outbound bodies, so it never arrives).
///
...
enum RpcErrorCode {
  badRequest('gateway/bad-request'),
  cancelled('gateway/cancelled'),
  sessionNotFound('session/not-found'),
  messageFeedbackSessionNotFound('session-not-found'),
  modelUnavailable('session/model-unavailable'),
  sessionConflict('session/conflict'),
  invalidTimeZone('session/invalid-time-zone'),
  subagentInvalidTimeZone('subagent/invalid-time-zone'),
  workspaceAttachFailed('session/workspace-attach-failed'),
  ...
  directoryUnreadable('directory-picker/unreadable'),
  directoryExists('directory-picker/exists'),
  directoryCreateFailed('directory-picker/create-failed'),
  directoryPickerUnavailable('directory-picker/unavailable'),
  workspaceFileNotFound('workspace-file/not-found'),
  workspaceFileOutsideWorkspace('workspace-file/outside-workspace'),
  workspaceFileTooLarge('workspace-file/too-large'),
  workspaceFileNotText('workspace-file/not-text'),
  workspaceFileNotRegularFile('workspace-file/not-regular-file'),
  workspaceFileNotDirectory('workspace-file/not-directory'),
  workspaceFileUnsupportedAddress('workspace-file/unsupported-address'),
  workspaceFileUnknownWorkspace('workspace-file/unknown-workspace'),
  ...
  queueItemNotFound('session/queue-item-not-found'),
  ...
  modelDiscoveryRejected('llm/model-discovery-rejected'),
  titleInvalid('session/title-invalid'),
  forkUnavailable('session/fork-unavailable'),
  ...
  subagentAttachmentInvalid('subagent/attachment-invalid'),
  subagentProjectionsUnavailable('subagent/projections-unavailable'),
  sessionAttachmentInvalid('session/attachment-invalid'),
  ...
  gatewayAmbiguousEndpoint('gateway/ambiguous-endpoint'),
  gatewayArgumentsInvalid('gateway/arguments-invalid'),
  gatewayBindingInvalid('gateway/binding-invalid'),
  gatewayContextFailed('gateway/context-failed'),
  gatewayContextNotFound('gateway/context-not-found'),
  gatewayContextUnavailable('gateway/context-unavailable'),
  gatewayDefinitionUnavailable('gateway/definition-unavailable'),
  gatewayInputInvalid('gateway/input-invalid'),
  gatewayInvocationUnavailable('gateway/invocation-unavailable'),
  gatewayLookupFailed('gateway/lookup-failed'),
  gatewayLookupNotFound('gateway/lookup-not-found'),
  gatewayLookupUnavailable('gateway/lookup-unavailable'),
  gatewayMethodUnavailable('gateway/method-unavailable'),
  gatewayProviderMismatch('gateway/provider-mismatch'),
  gatewayResultInvalid('gateway/result-invalid'),
  gatewayServiceUnavailable('gateway/service-unavailable'),
  gatewaySignatureInvalid('gateway/signature-invalid');
