...
const Map<String, String> kModelsZh = {
  ...
  'protocolHint': '不在内置目录中的模型需要指定 API 协议（如 openai-completions、anthropic-messages）。',
  'fetchModels': '获取可用模型',
  'fetching': '正在询问提供方…',
...
const Map<String, String> kModelsEn = {
  ...
  'protocolHint': 'Models not in the installed catalog need an API protocol (e.g. openai-completions, anthropic-messages).',
