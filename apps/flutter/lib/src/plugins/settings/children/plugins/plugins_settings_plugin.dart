...
const Map<String, String> kPluginsZh = {
  ...
  'loadFailed': '加载插件配置失败',
  'retry': '重试',
  'countLine': '{count} 个插件设置 · 卡片由 settings.plugin.item 提供；不可用的插件不留痕迹。',
  'bashTitle': '终端',
...
const Map<String, String> kPluginsEn = {
  ...
  'loadFailed': 'Loading plugin configuration failed',
  'retry': 'Retry',
  'countLine': '{count} plugin settings · Cards are contributed via settings.plugin.item; unavailable plugins leave no trace.',
  'bashTitle': 'Shell',
