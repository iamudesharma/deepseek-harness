...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  terminalController: 'terminal.md',
  sandbox: 'sandbox.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  TerminalSendResult: 'terminal.md',
  ...
  DirectoryFilePage: 'workspace.md',
  DirectoryListing: 'workspace.md',
  DirectoryListOptions: 'workspace.md',
  DirectoryReadOptions: 'workspace.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  PairRequest: 'remote pairing wire contract is owned by packages/host/remote-access/src/types.ts',
  PairResult: 'remote pairing wire contract is owned by packages/host/remote-access/src/types.ts',
  DevicesResult: 'remote device roster wire contract is owned by packages/host/remote-access/src/types.ts',
  RefreshResult: 'remote token-refresh wire contract is owned by packages/host/remote-access/src/types.ts',
  RevokeRequest: 'remote device-revocation wire contract is owned by packages/host/remote-access/src/types.ts',
  WsTicketResult: 'remote stream-ticket wire contract is owned by packages/host/remote-access/src/types.ts',
  PushRegisterRequest: 'push registration wire contract is owned by packages/host/remote-notifications/src/types.ts',
  PushRegisterResult: 'push registration wire contract is owned by packages/host/remote-notifications/src/types.ts',
  PushUnregisterRequest: 'push registration wire contract is owned by packages/host/remote-notifications/src/types.ts',
  PushUnregisterResult: 'push registration wire contract is owned by packages/host/remote-notifications/src/types.ts',
